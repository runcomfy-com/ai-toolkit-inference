---
title: "Wan 2.1 T2V 1.3B LoRA Inference with Diffusers (AI Toolkit-trained)"
description: "Run wan21_1b LoRAs trained with ostris/ai-toolkit using the ai-toolkit-inference reference pipeline. Defaults, required inputs, and training preview vs inference mismatch notes."
keywords: "wan21_1b lora inference, Wan 2.1 T2V 1.3B diffusers pipeline, ai-toolkit wan21_1b inference, training preview vs inference mismatch, wan21-1b"
permalink: /models/wan21-1b/
---

← [Docs Home](../../) · [Model Catalog](../) · [HTTP API](../../api/) · [Troubleshooting](../../troubleshooting/)
# Wan 2.1 T2V 1.3B LoRA Inference with Diffusers (AI Toolkit-trained)
...
- Same API surface as Wan 2.1 14B, but with a smaller base checkpoint (lower VRAM requirement).
- Uses `diffusers.WanPipeline` for text-to-video.

## Preview-matching notes (training preview vs inference mismatch)

- Match `num_frames` and `fps` when comparing outputs.
